...
class _ListViewSettingsState extends State<ListViewSettings> {
  ...
  Widget build(BuildContext context) {
    return ResponsiveWidget(
      small: _buildListViewSettings(MediaQuery.sizeOf(context).width),
      normal: _buildListViewSettings(MediaQuery.sizeOf(context).width / 1.5),
      large: _buildListViewSettings(MediaQuery.sizeOf(context).width / 2),
      extraLarge: _buildListViewSettings(MediaQuery.sizeOf(context).width / 3),
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              IRectangleButton(
                leading: SvgPicture.asset(Assets.icons.common.icoCancel),
                title: 'Hủy',
                padding: const EdgeInsets.symmetric(horizontal: 4.0),
                onPressed: () => context.popSafety(),
              ),
              IRectangleButton(
                leading: SvgPicture.asset(Assets.icons.common.icoActionReturn),
                title: 'Cập Nhật',
                padding: const EdgeInsets.symmetric(horizontal: 4.0),
