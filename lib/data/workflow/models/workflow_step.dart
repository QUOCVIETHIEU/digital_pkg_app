...
extension WorkflowStepStatusExtension on WorkflowStepStatus {
  ...
  String get buttonTitleConfirm => switch (this) {
    ...
    WorkflowStepStatus.qcResult => 'Xác nhận',
    WorkflowStepStatus.qcConfirm => 'Xác nhận',
    WorkflowStepStatus.globalUpload => 'Xác nhận',
    WorkflowStepStatus.globalResult => 'Xác nhận',
    WorkflowStepStatus.pkgUpload => 'Xác nhận',
    WorkflowStepStatus.pkgResult => 'Xác nhận',
    WorkflowStepStatus.qcmInformation => 'Xác nhận',
    WorkflowStepStatus.qcmResult => 'Xác nhận',
